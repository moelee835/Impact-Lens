...
## 패턴 — 주석이 주장하는 보장과 코드가 실제로 하는 일이 어긋난 사례 4건
...
**주석이 주장하는 보장과 코드가 실제로 하는 일이 어긋난 사례가 이 마일스톤에서 4건 나왔고, 넷 다
...
**네 번이면 우연이 아니다.** 이 저장소의 주석은 코드가 보장하기를 **의도한 것**을 적는 경향이
있고, 네 번 다 그 보장이 실제로는 코드에 없었다.
